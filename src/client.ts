...
export class Client {
  protected static readonly hostReplaceRx = /(((http:\/\/((192\.168\.[0-9]{1,3}\.[0-9]{1,3})|localhost):[0-9]{1,4})|LOCAL_SERVER_URL)\/r)|\{*\**HOST_URL_GOES_HERE\**\}*/g;
  ...
  protected hostUpdatedSource(src: string): string | undefined {
